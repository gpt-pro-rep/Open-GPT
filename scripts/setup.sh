...
OPENAI_API_KEY=$OPENAI_API_KEY CODE=$CODE PORT=$PORT HOST_NAME=$HOST_NAME yarn build
OPENAI_API_KEY=$OPENAI_API_KEY CODE=$CODE PORT=$PORT HOST_NAME=$HOST_NAME yarn start
